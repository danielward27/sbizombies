...
test_that("Testing simulation 'sirc' rcpp function outputs correct dimension on training run?", {
...
test_that("Testing simulation 'sirc' rcpp function outputs correct dimension on initial run?", {
